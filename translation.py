class Translation(object):
    ...
    ABS_TEXT = " hey nigga head out."
    UPGRADE_TEXT = " "
    FORMAT_SELECTION = "Got the file buddy. \n if you want to add thumbail send me here\n and then click the needed format from the below buttons."
    SET_CUSTOM_USERNAME_PASSWORD = """If you want to download premium videos, provide in the following format:
URL | filename | username | password"""
    NOYES_URL = "@GetPublicLinkBot URL detected. Please do not abuse the service!"
    DOWNLOAD_START = "Your request is in the queue buddy.Be Patient don't spam here"
    UPLOAD_START = "Uploading 😪"
    RCHD_BOT_API_LIMIT = "Size greater than maximum allowed size (50MB). Neverthless, trying to upload."
    RCHD_TG_API_LIMIT = "Downloaded the file in {} seconds.\nDetected File Size 😳: {}\nSorry. But, I cannot upload files greater than 1.5GB"
    AFTER_SUCCESSFUL_UPLOAD_MSG = "Mission Passed Respect+!"
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Downloaded in {} seconds. And \nUploaded in {} seconds. I'm speed"
    ...
    NO_VOID_FORMAT_FOUND = "something is wrong with the url punk, check again .\n<b>YouTubeDL</b> said: {}"
